...
![convnet](.\pics\3250cbba812d68265cf7815d987bcd1b.png)
...
## [定义网络](https://pytorch.apachecn.org/#/docs/1.7/05?id=定义网络)
...
## [损失函数](https://pytorch.apachecn.org/#/docs/1.7/05?id=损失函数)
...
## [反向传播](https://pytorch.apachecn.org/#/docs/1.7/05?id=反向传播)
...
## [更新权重](https://pytorch.apachecn.org/#/docs/1.7/05?id=更新权重)
...
观察如何使用`optimizer.zero_grad()`将梯度缓冲区手动设置为零。 这是因为如[反向传播](https://pytorch.apachecn.org/#/docs/1.7/05?id=backprop)部分中所述累积了梯度。